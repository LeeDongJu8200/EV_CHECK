...
class AdminGalleryAdapter(): RecyclerView.Adapter<AdminGalleryAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view: View = inflater.inflate(R.layout.admin_photo, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        Glide.with(context)
            ...
            .into(holder.admin_galleryView)       // 보여줄 위치
    }
    // 아이템 갯수
    ...
    class ViewHolder(view: View): RecyclerView.ViewHolder(view) {
        val admin_galleryView: ImageView = view.findViewById(R.id.admin_galleryView)
    }
}
